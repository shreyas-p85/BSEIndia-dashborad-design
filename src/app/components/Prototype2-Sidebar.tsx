    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 flex relative">
        ...
        >
          ...
          <nav className="overflow-y-auto h-[calc(100vh-150px)]">
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-4 border-b border-gray-100 transition-colors ${
                    isActive
                      ? "bg-blue-50 border-l-4 border-l-[#243166]"
                      : "hover:bg-gray-50"
                  }`}
                >
                  <Icon
                    className={`w-5 h-5 ${isActive ? "text-[#243166]" : "text-gray-600"}`}
                  />
                  <div className="flex-1 text-left">
                    <div
                      className={`text-sm font-semibold ${isActive ? "text-[#243166]" : "text-gray-800"}`}
                    >
                      {category.title}
                    </div>
                    {category.subtitle && (
                  ...
                  <ChevronRight
                    className={`w-4 h-4 ${isActive ? "text-[#243166]" : "text-gray-400"}`}
                  />
                </button>
              );
            })}
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className={`${currentCategory.color} p-3 rounded-lg bg-[#243166]`}
                      >
